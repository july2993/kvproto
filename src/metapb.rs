...
pub struct StoreLabel {
    // message fields
    pub key: ::protobuf::chars::Chars,
    pub value: ::protobuf::chars::Chars,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl StoreLabel {
    ...
    // Param is passed by value, moved
    pub fn set_key(&mut self, v: ::protobuf::chars::Chars) {
        self.key = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_key(&mut self) -> &mut ::protobuf::chars::Chars {
        &mut self.key
    }

    // Take field
    pub fn take_key(&mut self) -> ::protobuf::chars::Chars {
        ::std::mem::replace(&mut self.key, ::protobuf::chars::Chars::new())
    }
    ...
    fn get_key_for_reflect(&self) -> &::protobuf::chars::Chars {
        &self.key
    }

    fn mut_key_for_reflect(&mut self) -> &mut ::protobuf::chars::Chars {
        &mut self.key
    }
    ...
    pub fn clear_value(&mut self) {
        ::protobuf::Clear::clear(&mut self.value);
    }

    // Param is passed by value, moved
    pub fn set_value(&mut self, v: ::protobuf::chars::Chars) {
        self.value = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_value(&mut self) -> &mut ::protobuf::chars::Chars {
        &mut self.value
    }

    // Take field
    pub fn take_value(&mut self) -> ::protobuf::chars::Chars {
        ::std::mem::replace(&mut self.value, ::protobuf::chars::Chars::new())
    }
    ...
    fn get_value_for_reflect(&self) -> &::protobuf::chars::Chars {
        &self.value
    }

    fn mut_value_for_reflect(&mut self) -> &mut ::protobuf::chars::Chars {
        &mut self.value
    }
}
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_carllerche_string_into(wire_type, is, &mut self.value)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
pub struct Store {
    // message fields
    pub id: u64,
    pub address: ::protobuf::chars::Chars,
...
impl Store {
    ...
    pub fn clear_address(&mut self) {
        ::protobuf::Clear::clear(&mut self.address);
    }

    // Param is passed by value, moved
    pub fn set_address(&mut self, v: ::protobuf::chars::Chars) {
        self.address = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_address(&mut self) -> &mut ::protobuf::chars::Chars {
        &mut self.address
    }

    // Take field
    pub fn take_address(&mut self) -> ::protobuf::chars::Chars {
        ::std::mem::replace(&mut self.address, ::protobuf::chars::Chars::new())
    }
    ...
    fn get_address_for_reflect(&self) -> &::protobuf::chars::Chars {
        &self.address
    }

    fn mut_address_for_reflect(&mut self) -> &mut ::protobuf::chars::Chars {
        &mut self.address
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_carllerche_string_into(wire_type, is, &mut self.address)?;
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0cmetapb.proto\x12\x06metapb\x1a\x14gogoproto/gogo.proto\x1a\x0frust\
    proto.proto\"?\n\x07Cluster\x12\x0e\n\x02id\x18\x01\x20\x01(\x04R\x02id\
    \x12$\n\x0emax_peer_count\x18\x02\x20\x01(\rR\x0cmaxPeerCount\"4\n\nStor\
    eLabel\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\
    \x18\x02\x20\x01(\tR\x05value\"\x87\x01\n\x05Store\x12\x0e\n\x02id\x18\
    \x01\x20\x01(\x04R\x02id\x12\x18\n\x07address\x18\x02\x20\x01(\tR\x07add\
    ress\x12(\n\x05state\x18\x03\x20\x01(\x0e2\x12.metapb.StoreStateR\x05sta\
    te\x12*\n\x06labels\x18\x04\x20\x03(\x0b2\x12.metapb.StoreLabelR\x06labe\
    ls\"B\n\x0bRegionEpoch\x12\x19\n\x08conf_ver\x18\x01\x20\x01(\x04R\x07co\
    nfVer\x12\x18\n\x07version\x18\x02\x20\x01(\x04R\x07version\"\xaa\x01\n\
    \x06Region\x12\x0e\n\x02id\x18\x01\x20\x01(\x04R\x02id\x12\x1b\n\tstart_\
    key\x18\x02\x20\x01(\x0cR\x08startKey\x12\x17\n\x07end_key\x18\x03\x20\
    \x01(\x0cR\x06endKey\x126\n\x0cregion_epoch\x18\x04\x20\x01(\x0b2\x13.me\
    tapb.RegionEpochR\x0bregionEpoch\x12\"\n\x05peers\x18\x05\x20\x03(\x0b2\
    \x0c.metapb.PeerR\x05peers\"1\n\x04Peer\x12\x0e\n\x02id\x18\x01\x20\x01(\
    \x04R\x02id\x12\x19\n\x08store_id\x18\x02\x20\x01(\x04R\x07storeId*0\n\n\
    StoreState\x12\x06\n\x02Up\x10\0\x12\x0b\n\x07Offline\x10\x01\x12\r\n\tT\
    ombstone\x10\x02B.\n\x18com.pingcap.tikv.kvproto\xe0\xe2\x1e\x01\xa0\xa7\
    \x08\x01\xd0\xe2\x1e\x01\xc8\xe2\x1e\x01\x98\xa7\x08\x01J\xcc\x12\n\x06\
    \x12\x04\0\0>\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\x12\
    \x03\x01\x08\x0e\n\t\n\x02\x03\0\x12\x03\x03\x07\x1d\n\t\n\x02\x03\x01\
    \x12\x03\x04\x07\x18\n\x08\n\x01\x08\x12\x03\x06\09\n\x0b\n\x04\x08\xe7\
    \x07\0\x12\x03\x06\09\n\x0c\n\x05\x08\xe7\x07\0\x02\x12\x03\x06\x071\n\r\
    \n\x06\x08\xe7\x07\0\x02\0\x12\x03\x06\x071\n\x0e\n\x07\x08\xe7\x07\0\
    \x02\0\x01\x12\x03\x06\x080\n\x0c\n\x05\x08\xe7\x07\0\x03\x12\x03\x0648\
    \n\x08\n\x01\x08\x12\x03\x07\0:\n\x0b\n\x04\x08\xe7\x07\x01\x12\x03\x07\
    \0:\n\x0c\n\x05\x08\xe7\x07\x01\x02\x12\x03\x07\x072\n\r\n\x06\x08\xe7\
    \x07\x01\x02\0\x12\x03\x07\x072\n\x0e\n\x07\x08\xe7\x07\x01\x02\0\x01\
    \x12\x03\x07\x081\n\x0c\n\x05\x08\xe7\x07\x01\x03\x12\x03\x0759\n\x08\n\
    ...
    \xe7\x07\x04\x03\x12\x03\x0b%)\n\x08\n\x01\x08\x12\x03\r\01\n\x0b\n\x04\
    \x08\xe7\x07\x05\x12\x03\r\01\n\x0c\n\x05\x08\xe7\x07\x05\x02\x12\x03\r\
    \x07\x13\n\r\n\x06\x08\xe7\x07\x05\x02\0\x12\x03\r\x07\x13\n\x0e\n\x07\
    \x08\xe7\x07\x05\x02\0\x01\x12\x03\r\x07\x13\n\x0c\n\x05\x08\xe7\x07\x05\
    \x07\x12\x03\r\x160\n\n\n\x02\x04\0\x12\x04\x0f\0\x15\x01\n\n\n\x03\x04\
    \0\x01\x12\x03\x0f\x08\x0f\n\x0b\n\x04\x04\0\x02\0\x12\x03\x10\x04\x12\n\
    \r\n\x05\x04\0\x02\0\x04\x12\x04\x10\x04\x0f\x11\n\x0c\n\x05\x04\0\x02\0\
    \x05\x12\x03\x10\x04\n\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03\x10\x0b\r\n\
    \x0c\n\x05\x04\0\x02\0\x03\x12\x03\x10\x10\x11\n\x82\x01\n\x04\x04\0\x02\
    \x01\x12\x03\x13\x04\x1e\x1a\\\x20max\x20peer\x20count\x20for\x20a\x20re\
    gion.\n\x20pd\x20will\x20do\x20the\x20auto-balance\x20if\x20region\x20pe\
    er\x20count\x20mismatches.\n\"\x17\x20more\x20attributes......\n\n\r\n\
    \x05\x04\0\x02\x01\x04\x12\x04\x13\x04\x10\x12\n\x0c\n\x05\x04\0\x02\x01\
    \x05\x12\x03\x13\x04\n\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03\x13\x0b\x19\
    \n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03\x13\x1c\x1d\n\n\n\x02\x05\0\x12\
    \x04\x17\0\x1b\x01\n\n\n\x03\x05\0\x01\x12\x03\x17\x05\x0f\n\x0b\n\x04\
    \x05\0\x02\0\x12\x03\x18\x04\x0b\n\x0c\n\x05\x05\0\x02\0\x01\x12\x03\x18\
    \x04\x06\n\x0c\n\x05\x05\0\x02\0\x02\x12\x03\x18\t\n\n\x0b\n\x04\x05\0\
    \x02\x01\x12\x03\x19\x04\x10\n\x0c\n\x05\x05\0\x02\x01\x01\x12\x03\x19\
    \x04\x0b\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03\x19\x0e\x0f\n\x0b\n\x04\
    \x05\0\x02\x02\x12\x03\x1a\x04\x12\n\x0c\n\x05\x05\0\x02\x02\x01\x12\x03\
    \x1a\x04\r\n\x0c\n\x05\x05\0\x02\x02\x02\x12\x03\x1a\x10\x11\nA\n\x02\
    \x04\x01\x12\x04\x1e\0!\x01\x1a5\x20Case\x20insensitive\x20key/value\x20\
    for\x20replica\x20constraints.\n\n\n\n\x03\x04\x01\x01\x12\x03\x1e\x08\
    \x12\n\x0b\n\x04\x04\x01\x02\0\x12\x03\x1f\x04\x13\n\r\n\x05\x04\x01\x02\
    \0\x04\x12\x04\x1f\x04\x1e\x14\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03\x1f\
    \x04\n\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03\x1f\x0b\x0e\n\x0c\n\x05\x04\
    \x01\x02\0\x03\x12\x03\x1f\x11\x12\n\x0b\n\x04\x04\x01\x02\x01\x12\x03\
    \x20\x04\x15\n\r\n\x05\x04\x01\x02\x01\x04\x12\x04\x20\x04\x1f\x13\n\x0c\
    \n\x05\x04\x01\x02\x01\x05\x12\x03\x20\x04\n\n\x0c\n\x05\x04\x01\x02\x01\
    \x01\x12\x03\x20\x0b\x10\n\x0c\n\x05\x04\x01\x02\x01\x03\x12\x03\x20\x13\
    \x14\n\n\n\x02\x04\x02\x12\x04#\0)\x01\n\n\n\x03\x04\x02\x01\x12\x03#\
    \x08\r\n\x0b\n\x04\x04\x02\x02\0\x12\x03$\x04\x12\n\r\n\x05\x04\x02\x02\
    \0\x04\x12\x04$\x04#\x0f\n\x0c\n\x05\x04\x02\x02\0\x05\x12\x03$\x04\n\n\
    ...
    \x02\x01\x12\x03&\x0f\x14\n\x0c\n\x05\x04\x02\x02\x02\x03\x12\x03&\x17\
    \x18\n$\n\x04\x04\x02\x02\x03\x12\x03'\x04#\"\x17\x20more\x20attributes.\
    .....\n\n\x0c\n\x05\x04\x02\x02\x03\x04\x12\x03'\x04\x0c\n\x0c\n\x05\x04\
    \x02\x02\x03\x06\x12\x03'\r\x17\n\x0c\n\x05\x04\x02\x02\x03\x01\x12\x03'\
    \x18\x1e\n\x0c\n\x05\x04\x02\x02\x03\x03\x12\x03'!\"\n\n\n\x02\x04\x03\
    \x12\x04+\00\x01\n\n\n\x03\x04\x03\x01\x12\x03+\x08\x13\nJ\n\x04\x04\x03\
    \x02\0\x12\x03-\x04\x18\x1a=\x20Conf\x20change\x20version,\x20auto\x20in\
    crement\x20when\x20add\x20or\x20remove\x20peer\n\n\r\n\x05\x04\x03\x02\0\
    \x04\x12\x04-\x04+\x15\n\x0c\n\x05\x04\x03\x02\0\x05\x12\x03-\x04\n\n\
    \x0c\n\x05\x04\x03\x02\0\x01\x12\x03-\x0b\x13\n\x0c\n\x05\x04\x03\x02\0\
    \x03\x12\x03-\x16\x17\nA\n\x04\x04\x03\x02\x01\x12\x03/\x04\x17\x1a4\x20\
    Region\x20version,\x20auto\x20increment\x20when\x20split\x20or\x20merge\
    ...
    \x12\x042\09\x01\n\n\n\x03\x04\x04\x01\x12\x032\x08\x0e\n\x0b\n\x04\x04\
    \x04\x02\0\x12\x033\x04\x12\n\r\n\x05\x04\x04\x02\0\x04\x12\x043\x042\
    \x10\n\x0c\n\x05\x04\x04\x02\0\x05\x12\x033\x04\n\n\x0c\n\x05\x04\x04\
    \x02\0\x01\x12\x033\x0b\r\n\x0c\n\x05\x04\x04\x02\0\x03\x12\x033\x10\x11\
    \n5\n\x04\x04\x04\x02\x01\x12\x035\x04\x18\x1a(\x20Region\x20key\x20rang\
    e\x20[start_key,\x20end_key).\n\n\r\n\x05\x04\x04\x02\x01\x04\x12\x045\
    \x043\x12\n\x0c\n\x05\x04\x04\x02\x01\x05\x12\x035\x04\t\n\x0c\n\x05\x04\
    \x04\x02\x01\x01\x12\x035\n\x13\n\x0c\n\x05\x04\x04\x02\x01\x03\x12\x035\
    \x16\x17\n\x0b\n\x04\x04\x04\x02\x02\x12\x036\x04\x16\n\r\n\x05\x04\x04\
    \x02\x02\x04\x12\x046\x045\x18\n\x0c\n\x05\x04\x04\x02\x02\x05\x12\x036\
    \x04\t\n\x0c\n\x05\x04\x04\x02\x02\x01\x12\x036\n\x11\n\x0c\n\x05\x04\
    \x04\x02\x02\x03\x12\x036\x14\x15\n\x0b\n\x04\x04\x04\x02\x03\x12\x037\
    \x04!\n\r\n\x05\x04\x04\x02\x03\x04\x12\x047\x046\x16\n\x0c\n\x05\x04\
    \x04\x02\x03\x06\x12\x037\x04\x0f\n\x0c\n\x05\x04\x04\x02\x03\x01\x12\
    \x037\x10\x1c\n\x0c\n\x05\x04\x04\x02\x03\x03\x12\x037\x1f\x20\n\x0b\n\
    \x04\x04\x04\x02\x04\x12\x038\x04\x1c\n\x0c\n\x05\x04\x04\x02\x04\x04\
    \x12\x038\x04\x0c\n\x0c\n\x05\x04\x04\x02\x04\x06\x12\x038\r\x11\n\x0c\n\
    \x05\x04\x04\x02\x04\x01\x12\x038\x12\x17\n\x0c\n\x05\x04\x04\x02\x04\
    \x03\x12\x038\x1a\x1b\n\n\n\x02\x04\x05\x12\x04;\0>\x01\n\n\n\x03\x04\
    \x05\x01\x12\x03;\x08\x0c\n\x0b\n\x04\x04\x05\x02\0\x12\x03<\x04\x12\n\r\
    \n\x05\x04\x05\x02\0\x04\x12\x04<\x04;\x0e\n\x0c\n\x05\x04\x05\x02\0\x05\
    \x12\x03<\x04\n\n\x0c\n\x05\x04\x05\x02\0\x01\x12\x03<\x0b\r\n\x0c\n\x05\
    \x04\x05\x02\0\x03\x12\x03<\x10\x11\n\x0b\n\x04\x04\x05\x02\x01\x12\x03=\
    \x04\x18\n\r\n\x05\x04\x05\x02\x01\x04\x12\x04=\x04<\x12\n\x0c\n\x05\x04\
    \x05\x02\x01\x05\x12\x03=\x04\n\n\x0c\n\x05\x04\x05\x02\x01\x01\x12\x03=\
    \x0b\x13\n\x0c\n\x05\x04\x05\x02\x01\x03\x12\x03=\x16\x17b\x06proto3\
";
