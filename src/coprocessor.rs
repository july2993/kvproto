...
impl KeyRange {
    ...
    pub fn set_start(&mut self, v: ::bytes::Bytes) {
        self.start = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_start(&mut self) -> &mut ::bytes::Bytes {
        &mut self.start
    }

    // Take field
    pub fn take_start(&mut self) -> ::bytes::Bytes {
        ::std::mem::replace(&mut self.start, ::bytes::Bytes::new())
    }
    ...
    fn get_start_for_reflect(&self) -> &::bytes::Bytes {
        &self.start
    }

    fn mut_start_for_reflect(&mut self) -> &mut ::bytes::Bytes {
        &mut self.start
    }
    ...
    // Param is passed by value, moved
    pub fn set_end(&mut self, v: ::bytes::Bytes) {
        self.end = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_end(&mut self) -> &mut ::bytes::Bytes {
        &mut self.end
    }

    // Take field
    pub fn take_end(&mut self) -> ::bytes::Bytes {
        ::std::mem::replace(&mut self.end, ::bytes::Bytes::new())
    }
    ...
    fn get_end_for_reflect(&self) -> &::bytes::Bytes {
        &self.end
    }

    fn mut_end_for_reflect(&mut self) -> &mut ::bytes::Bytes {
        &mut self.end
    }
}
...
impl ::protobuf::Message for KeyRange {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_proto3_carllerche_bytes_into(wire_type, is, &mut self.start)?;
                },
                2 => {
                    ::protobuf::rt::read_singular_proto3_carllerche_bytes_into(wire_type, is, &mut self.end)?;
                },
                _ => {
...
pub struct Response {
    ...
    pub other_error: ::protobuf::chars::Chars,
...
impl Response {
    ...
    pub fn clear_other_error(&mut self) {
        ::protobuf::Clear::clear(&mut self.other_error);
    }

    // Param is passed by value, moved
    pub fn set_other_error(&mut self, v: ::protobuf::chars::Chars) {
        self.other_error = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_other_error(&mut self) -> &mut ::protobuf::chars::Chars {
        &mut self.other_error
    }

    // Take field
    pub fn take_other_error(&mut self) -> ::protobuf::chars::Chars {
        ::std::mem::replace(&mut self.other_error, ::protobuf::chars::Chars::new())
    }
    ...
    fn get_other_error_for_reflect(&self) -> &::protobuf::chars::Chars {
        &self.other_error
    }

    fn mut_other_error_for_reflect(&mut self) -> &mut ::protobuf::chars::Chars {
        &mut self.other_error
    }
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                4 => {
                    ::protobuf::rt::read_singular_proto3_carllerche_string_into(wire_type, is, &mut self.other_error)?;
                },
                5 => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    pb.proto\x1a\x14gogoproto/gogo.proto\x1a\x0frustproto.proto\"2\n\x08KeyR\
    ange\x12\x14\n\x05start\x18\x01\x20\x01(\x0cR\x05start\x12\x10\n\x03end\
    \x18\x02\x20\x01(\x0cR\x03end\"\x88\x01\n\x07Request\x12*\n\x07context\
    \x18\x01\x20\x01(\x0b2\x10.kvrpcpb.ContextR\x07context\x12\x0e\n\x02tp\
    \x18\x02\x20\x01(\x03R\x02tp\x12\x12\n\x04data\x18\x03\x20\x01(\x0cR\x04\
    data\x12-\n\x06ranges\x18\x04\x20\x03(\x0b2\x15.coprocessor.KeyRangeR\
    \x06ranges\"\xbc\x02\n\x08Response\x12K\n\x04data\x18\x01\x20\x01(\x0cR\
    \x04dataB7\xda\xde\x1f/github.com/pingcap/tipb/sharedbytes.SharedBytes\
    \xc8\xde\x1f\0\x121\n\x0cregion_error\x18\x02\x20\x01(\x0b2\x0e.errorpb.\
    ErrorR\x0bregionError\x12)\n\x06locked\x18\x03\x20\x01(\x0b2\x11.kvrpcpb\
    .LockInfoR\x06locked\x12\x1f\n\x0bother_error\x18\x04\x20\x01(\tR\nother\
    Error\x12+\n\x05range\x18\x05\x20\x01(\x0b2\x15.coprocessor.KeyRangeR\
    \x05range\x127\n\x0cexec_details\x18\x06\x20\x01(\x0b2\x14.kvrpcpb.ExecD\
    etailsR\x0bexecDetailsB.\n\x18com.pingcap.tikv.kvproto\xa0\xa7\x08\x01\
    \xc8\xe2\x1e\x01\x98\xa7\x08\x01\xd0\xe2\x1e\x01\xe0\xe2\x1e\x01J\x99\r\
    \n\x06\x12\x04\0\0%\x01\n\x08\n\x01\x0c\x12\x03\0\0\x12\n\x08\n\x01\x02\
    \x12\x03\x01\x08\x13\n\t\n\x02\x03\0\x12\x03\x03\x07\x16\n\t\n\x02\x03\
    \x01\x12\x03\x04\x07\x16\n\t\n\x02\x03\x02\x12\x03\x05\x07\x1d\n\t\n\x02\
    \x03\x03\x12\x03\x06\x07\x18\n\x08\n\x01\x08\x12\x03\x08\09\n\x0b\n\x04\
    \x08\xe7\x07\0\x12\x03\x08\09\n\x0c\n\x05\x08\xe7\x07\0\x02\x12\x03\x08\
    \x071\n\r\n\x06\x08\xe7\x07\0\x02\0\x12\x03\x08\x071\n\x0e\n\x07\x08\xe7\
    \x07\0\x02\0\x01\x12\x03\x08\x080\n\x0c\n\x05\x08\xe7\x07\0\x03\x12\x03\
    \x0848\n\x08\n\x01\x08\x12\x03\t\0:\n\x0b\n\x04\x08\xe7\x07\x01\x12\x03\
    \t\0:\n\x0c\n\x05\x08\xe7\x07\x01\x02\x12\x03\t\x072\n\r\n\x06\x08\xe7\
    \x07\x01\x02\0\x12\x03\t\x072\n\x0e\n\x07\x08\xe7\x07\x01\x02\0\x01\x12\
    \x03\t\x081\n\x0c\n\x05\x08\xe7\x07\x01\x03\x12\x03\t59\n\x08\n\x01\x08\
    \x12\x03\x0b\0(\n\x0b\n\x04\x08\xe7\x07\x02\x12\x03\x0b\0(\n\x0c\n\x05\
    \x08\xe7\x07\x02\x02\x12\x03\x0b\x07\x20\n\r\n\x06\x08\xe7\x07\x02\x02\0\
    \x12\x03\x0b\x07\x20\n\x0e\n\x07\x08\xe7\x07\x02\x02\0\x01\x12\x03\x0b\
    \x08\x1f\n\x0c\n\x05\x08\xe7\x07\x02\x03\x12\x03\x0b#'\n\x08\n\x01\x08\
    \x12\x03\x0c\0$\n\x0b\n\x04\x08\xe7\x07\x03\x12\x03\x0c\0$\n\x0c\n\x05\
    \x08\xe7\x07\x03\x02\x12\x03\x0c\x07\x1c\n\r\n\x06\x08\xe7\x07\x03\x02\0\
    \x12\x03\x0c\x07\x1c\n\x0e\n\x07\x08\xe7\x07\x03\x02\0\x01\x12\x03\x0c\
    \x08\x1b\n\x0c\n\x05\x08\xe7\x07\x03\x03\x12\x03\x0c\x1f#\n\x08\n\x01\
    \x08\x12\x03\r\0*\n\x0b\n\x04\x08\xe7\x07\x04\x12\x03\r\0*\n\x0c\n\x05\
    \x08\xe7\x07\x04\x02\x12\x03\r\x07\"\n\r\n\x06\x08\xe7\x07\x04\x02\0\x12\
    ...
    \0\x15\x01\x1a\x0e\x20[start,\x20end)\n\n\n\n\x03\x04\0\x01\x12\x03\x12\
